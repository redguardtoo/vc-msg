...
The current VCS will be detected automatically. If for some reason you need force the VCS type (Peforce, for example), it's just one liner =(setq vc-msg-force-vcs "p4")=.
